...
<div class="w-full max-w-md bg-slate-900/80 border border-slate-800 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
    <div class="mb-6 text-center">
        ...
        <p class="text-sm text-slate-400 mt-1">Build your ultimate PC with DreamPC</p>
    </div>
    ...
    <form method="POST" action="/register" class="space-y-4">
        <?php echo csrf_field(); ?>
        <div>
            <label for="name" class="block text-xs font-medium text-slate-400 mb-1">Full Name</label>
        ...
        <div>
            <label for="password_confirmation" class="block text-xs font-medium text-slate-400 mb-1">Confirm Password</label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Arfa\Desktop\ProjectDreamPC\DreamPC\resources\views/auth/register.blade.php ENDPATH**/ ?>